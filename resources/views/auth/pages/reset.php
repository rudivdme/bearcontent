<script data-route-id="reset" data-route-title="<?php echo ba_title('Reset Password')  ?>" type="text/x-handlebars-template">
	<div class="animated bear-content max450">
		...
		<hr class="spacer" />
		<h1 class="center-align"><span id="bear-speak" class="ba-tooltip c-white" title="It's a good day." data-position="right"><?php echo trans('bear::speak.oops') ?></span></h1>
		...
		<?php echo Form::open(['url' => url('bear/password/reset'), 'class' => 'ba-single-column', 'data-done-route' => "/change"]); ?>
			<div class="ba-field">
